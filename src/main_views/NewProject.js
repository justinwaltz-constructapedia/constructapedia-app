...
function NewProject(props) {
    ...
    return (
        <div>
            ...
            <ul className='collection with-header indigo-text'>
                <li className='collection-header'>
                    <p>
                        <b>Start Planning Your Project</b>
                    </p>
                </li>
                        ...
                        <div className='col s12'>
                            <div className='input-field inline'>
                                <input
                                    ...
                                    onChange={(e) =>
                                        setPlanTitleValue(e.target.value)
                                    }
                                />
                                <label htmlFor='new_title_input'>
                ...
                <li className='collection-header'>
                    <p>
                        <b>Start Researching Your Project</b>
                    </p>
                </li>
                <li className='collection-item'>
                    <SearchResults
