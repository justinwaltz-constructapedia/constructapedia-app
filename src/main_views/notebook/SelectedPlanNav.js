...
function SelectedPlanNav(props) {
    ...
    return (
        <div className="row">
            <div className="table-of-contents col s12">
                ...
                <div className="valign-wrapper row blue-grey darken-4 blue-grey-text text-lighten-5 no-margin">
                    <div className="col s8">
                        <a href={"#"+props.selectedPlan.id} className="blue-grey darken-4 blue-grey-text text-lighten-4">
                            <h6 display="inline" className="sub-plan-link no-margin">{props.selectedPlan.title}</h6>
                        </a>
                    </div>
                    <div className="col s2 no-padding">
                        <i className="material-icons no-margin">arrow_upward</i>
                    </div>
                    <div className="col s2 no-padding">
                        <button className="btn-flat center-align right waves-effect waves-light blue-grey darken-4 blue-grey-text text-lighten-5 no-padding"
                            ...
                            {props.selectedPlan.sub_plans &&
                                props.selectedPlan.sub_plans.map((subPlan, i) => {
                                    return (<li key={subPlan.title + i} className="blue-grey darken-4 blue-grey-text text-lighten-5">
                                                <a href={"#"+subPlan.id} className="sub-plan-link collapsible-header blue-grey darken-4 blue-grey-text text-lighten-4">
                                                    {subPlan.title}
...
export default SelectedPlanNav;
